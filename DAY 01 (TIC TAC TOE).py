...
BG_COLOUR=(42, 201, 135)
LINE_COLOUR=(38, 150, 107)
CIRCLE_COLOUR=(221, 240, 185)
...
while True:
	for event in pygame.event.get():
		...
		if event.type==pygame.MOUSEBUTTONDOWN and not game_over:
			mouseX=event.pos[0] #X value
			mouseY=event.pos[1] #Y value
